...
export function LoginModal({ isOpen, onClose, handleSignIn }: Props) {
  return (
    <div
    ...
    >
      ...
      <div className='relative mx-auto  bg-white shadow-2xl rounded-lg md:p-20 transform transition-all md:max-w-xl w-full '>
        <div className='flex flex-col items-center '>
          <p className='mb-5 text-gray-900 font-mono font-normal text-xl whitespace-nowrap'>
            Para ir al dashboard de administración
          </p>
