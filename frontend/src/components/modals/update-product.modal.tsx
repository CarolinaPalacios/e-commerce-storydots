          ...
          <div className='flex flex-col space-y-4'>
            ...
            <div className='relative'>
              ...
              <input
                ...
                onChange={handleInputChange}
                placeholder='Precio'
                className='w-full appearance-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md pl-10'
              />
            </div>
            <input
              type='text'
